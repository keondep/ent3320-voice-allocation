...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 468.0, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 31.0, 417.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 508.901595592498779, 60.0, 22.0 ],
					"text" : "s mute.all"
				}
...
,
					"patching_rect" : [ 282.0, 375.0, 75.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 621.0, 385.0, 50.0, 22.0 ],
					"text" : "0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.0, 390.0, 50.0, 22.0 ],
					"text" : "1 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "", "", "" ],
					"patching_rect" : [ 389.0, 364.0, 206.0, 22.0 ],
					"text" : "poly~ controlling.bach.polycore.v13 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.25, 333.0, 79.0, 22.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 468.382979035377502, 495.776595592498779, 48.25, 48.25 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 661.0, 447.0, 78.0, 20.0 ],
					"text" : "<live.gain~>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 449.0, 425.5, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 722.952475247524944, 333.0, 97.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 56.489361763000488, 117.680851101875305, 758.207794366024586, 191.98581556479138 ],
					"pitcheditrange" : [ "null" ],
					"ruler" : 3,
					"showplayhead" : 1,
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 7.0, 339.0, 29.0 ],
					"text" : "13.controlling poly with bach slots"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "z.credits.v01.bp.maxpat",
				"bootpath" : "~/Documents/school/tech pro/ent3320-voice-allocation/tutorial.01a.bach.poly~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "controlling.bach.polycore.v13.maxpat",
				"bootpath" : "~/Documents/school/tech pro/ent3320-voice-allocation/tutorial.01a.bach.poly~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
